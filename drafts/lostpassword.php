    ...
    <form id="rcp_lostpassword_form" class="rcp_form" method="POST" action="<?php echo esc_url( add_query_arg( 'rcp_action', 'lostpassword') ); ?>">
        ...
        <fieldset class="rcp_lostpassword_data">
            <div class="registration_user-email">
                <input name="rcp_user_login" id="rcp_user_login" class="required" type="text" placeholder="Username or E-mail"/>
            </div>
            ...
            <p>
                ...
                <input id="rcp_lostpassword_submit" class="rcp-button registration-form_btn" type="submit" value="<?php esc_attr_e( 'Request Password Reset', 'rcp' ); ?>"/>
            </p>
